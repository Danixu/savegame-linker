...
class MainFrame(wx.Frame):
  ...
  def createWidgets(self):
    ...
    ### Páginas a crear para los paneles ###
    ...
    class addPage(wx.Panel):
      ...
      def __init__(self, parent):
        ...
        ## Add Button ###
        image_iconup = wx.Image(str(MainFrame.dataFolder["images"] / 'folder_close.png'),
            wx.BITMAP_TYPE_ANY );
        image_iconover = wx.Image(str(MainFrame.dataFolder["images"] / 'folder_open.png'),
            wx.BITMAP_TYPE_ANY );
        image_icondown = wx.Image(str(MainFrame.dataFolder["images"] / 'folder_click.png'),
            wx.BITMAP_TYPE_ANY );
        ...
        button_icon = ShapedButton(self, 
            ...
            audio_enter=str(MainFrame.dataFolder["audio"] / 'High1.ogg'),
            audio_click=str(MainFrame.dataFolder["audio"] / 'Click1.ogg')
          );
        ...
        ### Add Button ###
        image_addup = wx.Image(str(MainFrame.dataFolder["images"] / 'add_up.png'),
            wx.BITMAP_TYPE_ANY );
        image_adddown = wx.Image(str(MainFrame.dataFolder["images"] / 'add_down.png'),
            wx.BITMAP_TYPE_ANY );
        ...
        ### Remove Button ###
        image_remup = wx.Image(str(MainFrame.dataFolder["images"] / 'remove_up.png'),
            wx.BITMAP_TYPE_ANY );
        image_remdown = wx.Image(str(MainFrame.dataFolder["images"] / 'remove_down.png'),
            wx.BITMAP_TYPE_ANY );
        ...
        self.btnCancelar.Bind(wx.EVT_LEFT_DOWN, exitGUI);
    ...
    self.panel.SetBackgroundColour(BACKGROUNDCOLOR);
    self.panel.SetSizerAndFit(boxSizer);
    
    self.notebook = wx.Notebook(self.panel);
    search_page = searchPage(self.notebook);
    add_page = addPage(self.notebook);
    self.notebook.AddPage(search_page, "Buscar Juegos");
    self.notebook.AddPage(add_page, "Añadir manualmente");
...
#======================
app = wx.App()
MainFrame(None, style= wx.SYSTEM_MENU | wx.CAPTION | wx.CLOSE_BOX, title="Añadir juego", size=(485,520))
app.MainLoop()
