...
#    staticBox = wx.StaticBox( self.panel, -1, "Listado de Saves", size=(414, 500),
 #             pos=wx.Point(4, 0) )   
  ...
  def createButtons(self):
    ...
    ### Add Button ###
    image_addup = wx.Image(str(self.dataFolder["images"] / 'add_up.png'),
        wx.BITMAP_TYPE_ANY );
    image_adddown = wx.Image(str(self.dataFolder["images"] / 'add_down.png'),
        wx.BITMAP_TYPE_ANY );
    ...
    button_add = ShapedButton(self.panel, 
        ...
        audio_enter=str(self.dataFolder["audio"] / 'High1.ogg'),
        audio_click=str(self.dataFolder["audio"] / 'Click1.ogg')
      );
    button_add.Bind(wx.EVT_LEFT_DOWN, AddButtonClick);
    
    ### Remove Button ###
    image_remup = wx.Image(str(self.dataFolder["images"] / 'remove_up.png'),
        wx.BITMAP_TYPE_ANY );
    image_remdown = wx.Image(str(self.dataFolder["images"] / 'remove_down.png'),
        wx.BITMAP_TYPE_ANY );
    ...
    button_add.Bind(wx.EVT_LEFT_DOWN, RemButtonClick);
    
    ### Refresh Button ###
    image_refup = wx.Image(str(self.dataFolder["images"] / 'refresh_up.png'),
        wx.BITMAP_TYPE_ANY );
    image_refdown = wx.Image(str(self.dataFolder["images"] / 'refresh_down.png'),
        wx.BITMAP_TYPE_ANY );
    ...
    button_add.Bind(wx.EVT_LEFT_DOWN, RefreshButtonClick);
    
    ### Run Button ###
    image_runup = wx.Image(str(self.dataFolder["images"] / 'run_up.png'),
        wx.BITMAP_TYPE_ANY );
    image_rundown = wx.Image(str(self.dataFolder["images"] / 'run_down.png'),
        wx.BITMAP_TYPE_ANY );
